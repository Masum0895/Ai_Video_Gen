...
export const createProject = async(req:Request, res:Response)=>{
    ...
    const {name = 'New Project', aspectRatio, userPrompt, productName, productDescription, targetLength = 7} = req.body;
...
// images to base64 structure for ai model
        ...
        const prompt = {
            text: `Combine the person and product into a realistic photo. Maske the person naturally hold or use the product. Match lighting, shadows, scale and perspective. Make the person stand in professional studio lighting. Output ecommerce-quality photo realistic imagery. ${userPrompt}`
        }
